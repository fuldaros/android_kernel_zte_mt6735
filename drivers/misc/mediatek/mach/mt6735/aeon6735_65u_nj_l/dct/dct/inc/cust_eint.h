...
#define CUST_EINT_OTG_IDDIG_NUM              0
#define CUST_EINT_OTG_IDDIG_DEBOUNCE_CN      256
#define CUST_EINT_OTG_IDDIG_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_OTG_IDDIG_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_ENABLE
